...
class AnomalyDetector:
    ...
    def detect(self, df: pd.DataFrame, value_col: str = "Oxygen[%sat]") -> pd.DataFrame:
        """
        ...
        results_df["anomaly_type"] = results_df["is_anomaly"].apply(lambda x: "point" if x else "normal")
    ...
    def save(self, filepath: str):
        ...
        save_dict = {"statistical_detector": self.statistical_detector, "weights": self.weights}
