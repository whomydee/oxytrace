...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--data-percent", type=float, default=10.0, help="Percentage of data to use for training (default: 10%%)"
    )

    parser.add_argument(
        "--train-anomaly-detector", action="store_true", default=True, help="Train anomaly detection model"
    )
